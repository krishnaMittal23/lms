    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p
            className={`pt-2 md:text-base text-sm transition-all duration-300 ${
              showFullDesc ? "" : "max-h-27 overflow-hidden"
            }`}
          ...
          <button
            ...
            className="text-blue-500 text-sm mt-1 cursor-grab"
          >
            {showFullDesc ? "Show Less" : "Read More"}
          </button>

          {/* Review and rating */}
          <div className="flex items-center space-x-2 pt-3 pb-1 text-sm mt-2 mb-2">
          ...
          <p className="text-sm">
            Course by <span className="text-blue-600 underline">Elon Musk</span>
          </p>
          ...
          <div className="pt-8 text-gray-800">
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index) => (
                <div
                  key={index}
                  className="border bg-white mb-2 rounded"
                >
                  <div
        ...
        {/* Right column */}
        <div className='max-w-[424px] z-10 shadow-lg rounded-t md:rounded-lg overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>

              {/* if we have playerData show video else show image */}
        {
